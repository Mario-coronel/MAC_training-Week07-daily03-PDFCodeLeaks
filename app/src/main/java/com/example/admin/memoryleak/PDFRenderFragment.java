...
class PDFRenderFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int index = 0;
        try {
            openRenderer(this.getParentFragment().getActivity());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void openRenderer(Activity activity) throws IOException {
        ...
        fileDescriptor = activity.getAssets().openFd("dantesinferno.pdf").getParcelFileDescriptor();
